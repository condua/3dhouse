  ...
  return (
    <div className="p-4">
      <h2 className="md:text-2xl text-sm font-bold mb-4">
        Thống kê số tiền ủng hộ qua ngân hàng BIDV số tài khoản 1261122666 từ
        ngày 1/9/2024 đến ngày 12/9/2024
      </h2>
